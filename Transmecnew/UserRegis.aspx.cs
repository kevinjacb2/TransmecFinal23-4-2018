...
public partial class UserRegis : System.Web.UI.Page
{
    ...
    protected void btninsert_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string str;
            str = "insert into ClientDetail values('" + txtClientName.Text + "','" + x + "','" + txtaddr.Text + "'," + ddlstateid.SelectedValue + ",'" + txtcity.Text + "','" + txtcontactno.Text + "','" + txtemailid.Text + "','" + Convert.ToDateTime(txtbrthdate.Text).ToString("yyyy/MM/dd") + "','" + txtPwd.Text + "','" + DropDownList1.SelectedItem + "')";
