...
public partial class ShowBuyProduct : System.Web.UI.Page
{
    ...
    void addCategory()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ddlProdCate.Items.Insert(0, "Select");
        }
    }
    ...
    protected void ddlProdCate_SelectedIndexChanged1(object sender, EventArgs e)
    {
    ...
    protected void lnkbuyProd_Click(object sender, EventArgs e)
    {
