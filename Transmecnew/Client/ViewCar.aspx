<%@ Page Title="" Language="C#" MasterPageFile="~/Client/MasterPage.master" AutoEventWireup="true" CodeFile="ViewCar.aspx.cs" Inherits="Client_ViewCar" %>
                    ...
                    <div id="divLocal" runat="server">
                         <tr>
                            ...
                            <td>
                                ...
                                <cc1:CalendarExtender ID="txtLocalDate_CalendarExtender" runat="server" 
                                    Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtLocalDate">
                                </cc1:CalendarExtender>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnBooklocal" runat="server" Text="Book" 
                                    OnClick="btnBook_Click" CssClass="button" />
                            </td>
                        </tr>
                    </div>
